...
public class PipelineUtil {
     ...
     * @throws Exception If an exception happens while executing
     */
    public static List<Object> callDecode(ByteToMessageDecoder decoder, ChannelHandlerContext ctx, ByteBuf input) throws Exception {
    ...
    public static void callEncode(MessageToByteEncoder encoder, ChannelHandlerContext ctx, Object msg, ByteBuf output) throws Exception {
        NettyCodecInternals.callEncode(encoder, ctx, msg, output);
    }
    ...
    public static List<Object> callDecode(MessageToMessageDecoder decoder, ChannelHandlerContext ctx, Object msg) throws Exception {
        return NettyCodecInternals.callDecode(decoder, ctx, msg, new ArrayList<>());
    }
