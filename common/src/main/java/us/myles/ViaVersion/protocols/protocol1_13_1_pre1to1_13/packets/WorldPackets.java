...
import us.myles.ViaVersion.protocols.protocol1_13_1_pre1to1_13.Protocol1_13_1_pre1TO1_13;
                            ...
                            if (section != null) {
                                for (int i = 0; i < section.getPalette().size(); i++) {
                                    section.getPalette().set(
                                            i,
                                            Protocol1_13_1_pre1TO1_13.getNewBlockStateId(section.getPalette().get(i))
                                    );
                                }
                            }
                        }
        ...
        protocol.registerOutgoing(State.PLAY, 0x0A, 0x0A, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                handler(new PacketHandler() {
                    @Override
                    public void handle(PacketWrapper wrapper) throws Exception {
                        wrapper.set(Type.VAR_INT, 0, Protocol1_13_1_pre1TO1_13.getNewBlockId(wrapper.get(Type.VAR_INT, 0)));
                    }
                });
            }
        });
            ...
            public void registerMap() {
                ...
                handler(new PacketHandler() {
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        wrapper.set(Type.VAR_INT, 0, Protocol1_13_1_pre1TO1_13.getNewBlockStateId(id));
                    }
                });
            }
        });
                ...
                handler(new PacketHandler() {
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        for (BlockChangeRecord record : wrapper.get(Type.BLOCK_CHANGE_RECORD_ARRAY, 0)) {
                            ...
                            record.setBlockId(Protocol1_13_1_pre1TO1_13.getNewBlockStateId(id));
                        }
                    }
                });
            }
                ...
                handler(new PacketHandler() {
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if (id == 1010) { // Play record
                            ...
                            wrapper.set(Type.INT, 1, data = Protocol1_13_1_pre1TO1_13.getNewBlockStateId(data));
                        }
                    }
                });
            }
                ...
                handler(new PacketHandler() {
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        if(id == 3 || id == 20){
                            ...
                            wrapper.set(Type.VAR_INT, 0, Protocol1_13_1_pre1TO1_13.getNewBlockStateId(data));
                        }
                    }
                });
            }
