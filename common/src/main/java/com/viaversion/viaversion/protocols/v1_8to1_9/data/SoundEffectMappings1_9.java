...
public enum SoundEffectMappings1_9 {
    ...
    DIG_GRAVEL("dig.gravel", "block.gravel.place", SoundCategories1_8.BLOCK),
    RANDOM_BOWHIT("random.bowhit", "block.tripwire.detach", SoundCategories1_8.NEUTRAL),
    ...
    MOB_COW_HURT("mob.cow.hurt", "entity.cow.death", SoundCategories1_8.NEUTRAL),
    ...
    MOB_SILVERFISH_KILL("mob.silverfish.kill", "entity.endermite.death", SoundCategories1_8.HOSTILE),
    ...
    DIG_STONE("dig.stone", "block.glass.place", SoundCategories1_8.BLOCK),
    ...
    MOB_SLIME_SMALL("mob.slime.small", "block.slime.hit", SoundCategories1_8.HOSTILE),
    ...
    RANDOM_CLICK("random.click", "block.wood_pressureplate.click_on", SoundCategories1_8.BLOCK),
    ...
    DIG_GRASS("dig.grass", "block.grass.place", SoundCategories1_8.BLOCK),
    ...
    GAME_PLAYER_HURT("game.player.hurt", "entity.player.death", SoundCategories1_8.PLAYER),
    ...
    DIG_WOOD("dig.wood", "block.ladder.break", SoundCategories1_8.BLOCK),
    ...
    AMBIENT_WEATHER_RAIN("ambient.weather.rain", "weather.rain.above", SoundCategories1_8.WEATHER),
    ...
    MOB_GHAST_FIREBALL("mob.ghast.fireball", "entity.blaze.shoot", SoundCategories1_8.HOSTILE),
    MOB_IRONGOLEM_DEATH("mob.irongolem.death", "entity.irongolem.death", SoundCategories1_8.NEUTRAL),
    RANDOM_BREAK("random.break", "item.shield.break", SoundCategories1_8.PLAYER),
    MOB_ZOMBIE_REMEDY("mob.zombie.remedy", "entity.zombie_villager.cure", SoundCategories1_8.HOSTILE),
    RANDOM_BOW("random.bow", "entity.splash_potion.throw", SoundCategories1_8.NEUTRAL),
    MOB_VILLAGER_IDLE("mob.villager.idle", "entity.villager.ambient", SoundCategories1_8.NEUTRAL),
    STEP_CLOTH("step.cloth", "block.cloth.fall", SoundCategories1_8.NEUTRAL),
    MOB_SILVERFISH_HIT("mob.silverfish.hit", "entity.endermite.hurt", SoundCategories1_8.HOSTILE),
    ...
    MOB_CHICKEN_PLOP("mob.chicken.plop", "entity.donkey.chest", SoundCategories1_8.NEUTRAL),
    MOB_ENDERDRAGON_WINGS("mob.enderdragon.wings", "entity.enderdragon.flap", SoundCategories1_8.HOSTILE),
    STEP_GRASS("step.grass", "block.grass.hit", SoundCategories1_8.NEUTRAL),
    ...
    MOB_SLIME_BIG("mob.slime.big", "entity.slime.death", SoundCategories1_8.HOSTILE),
    ...
    STEP_SAND("step.sand", "block.sand.fall", SoundCategories1_8.NEUTRAL),
    ...
    STEP_LADDER("step.ladder", "block.ladder.hit", SoundCategories1_8.NEUTRAL),
    ...
    MOB_SPIDER_SAY("mob.spider.say", "entity.spider.hurt", SoundCategories1_8.HOSTILE),
    STEP_STONE("step.stone", "block.anvil.hit", SoundCategories1_8.NEUTRAL, true), //Is used for glass placement sound
    ...
    DIG_CLOTH("dig.cloth", "block.cloth.place", SoundCategories1_8.BLOCK),
    STEP_GRAVEL("step.gravel", "block.gravel.hit", SoundCategories1_8.NEUTRAL),
    ...
    DIG_SNOW("dig.snow", "block.snow.place", SoundCategories1_8.BLOCK),
    ...
    MOB_CHICKEN_HURT("mob.chicken.hurt", "entity.chicken.death", SoundCategories1_8.NEUTRAL),
    ...
    RANDOM_EXPLODE("random.explode", "block.end_gateway.spawn", SoundCategories1_8.BLOCK),
