...
public enum ClientboundPackets1_19_1 implements ClientboundPacketType {
    ...
    INITIALIZE_BORDER, // 0x1F
    KEEP_ALIVE, // 0x20
    LEVEL_CHUNK_WITH_LIGHT, // 0x21
    LEVEL_EVENT, // 0x22
    ...
    PLAYER_CHAT, // 0x33
    PLAYER_COMBAT_END, // 0x34
    PLAYER_COMBAT_ENTER, // 0x35
    PLAYER_COMBAT_KILL, // 0x36
    PLAYER_INFO, // 0x37
    PLAYER_LOOK_AT, // 0x38
    PLAYER_POSITION, // 0x39
    RECIPE, // 0x3A
    REMOVE_ENTITIES, // 0x3B
    REMOVE_MOB_EFFECT, // 0x3C
    RESOURCE_PACK, // 0x3D
    RESPAWN, // 0x3E
    ROTATE_HEAD, // 0x3F
    SECTION_BLOCKS_UPDATE, // 0x40
    SELECT_ADVANCEMENTS_TAB, // 0x41
    SERVER_DATA, // 0x42
    SET_ACTION_BAR_TEXT, // 0x43
    SET_BORDER_CENTER, // 0x44
    SET_BORDER_LERP_SIZE, // 0x45
    SET_BORDER_SIZE, // 0x46
    SET_BORDER_WARNING_DELAY, // 0x47
    SET_BORDER_WARNING_DISTANCE, // 0x48
    SET_CAMERA, // 0x49
    SET_CARRIED_ITEM, // 0x4A
    SET_CHUNK_CACHE_CENTER, // 0x4B
    SET_CHUNK_CACHE_RADIUS, // 0x4C
    SET_DEFAULT_SPAWN_POSITION, // 0x4D
    SET_DISPLAY_CHAT_PREVIEW, // 0x4E
    SET_DISPLAY_OBJECTIVE, // 0x4F
    SET_ENTITY_DATA, // 0x50
    SET_ENTITY_LINK, // 0x51
    SET_ENTITY_MOTION, // 0x52
    SET_EQUIPMENT, // 0x53
    SET_EXPERIENCE, // 0x54
    SET_HEALTH, // 0x55
    SET_OBJECTIVE, // 0x56
    SET_PASSENGERS, // 0x57
    SET_PLAYER_TEAM, // 0x58
    SET_SCORE, // 0x59
    SET_SIMULATION_DISTANCE, // 0x5A
    SET_SUBTITLE_TEXT, // 0x5B
    SET_TIME, // 0x5C
    SET_TITLE_TEXT, // 0x5D
    SET_TITLES_ANIMATION, // 0x5E
    SOUND_ENTITY, // 0x5F
    SOUND, // 0x60
    STOP_SOUND, // 0x61
    SYSTEM_CHAT, // 0x62
    TAB_LIST, // 0x63
    TAG_QUERY, // 0x64
    TAKE_ITEM_ENTITY, // 0x65
    TELEPORT_ENTITY, // 0x66
    UPDATE_ADVANCEMENTS, // 0x67
    UPDATE_ATTRIBUTES, // 0x68
    UPDATE_MOB_EFFECT, // 0x69
    UPDATE_RECIPES, // 0x6A
    UPDATE_TAGS; // 0x6B
