 ...
 */
package com.viaversion.viaversion.protocols.v1_8to1_9.packets;
...
public class PlayerPackets {
    public static void register(Protocol1_8To1_9 protocol) {
        ...
        protocol.registerClientbound(ClientboundPackets1_8.TAB_LIST, new PacketHandlers() {
            @Override
            public void register() {
                map(Type.STRING, Protocol1_8To1_9.STRING_TO_JSON); // 0 - Header
                map(Type.STRING, Protocol1_8To1_9.STRING_TO_JSON); // 1 - Footer
            }
        });
        ...
        protocol.registerClientbound(ClientboundPackets1_8.DISCONNECT, new PacketHandlers() {
            @Override
            public void register() {
                map(Type.STRING, Protocol1_8To1_9.STRING_TO_JSON); // 0 - Reason
            }
        });
            ...
            public void register() {
                ...
                handler(wrapper -> {
                    ...
                    if (action == 0 || action == 1) {
                        Protocol1_8To1_9.STRING_TO_JSON.write(wrapper, wrapper.read(Type.STRING));
                    }
                });
