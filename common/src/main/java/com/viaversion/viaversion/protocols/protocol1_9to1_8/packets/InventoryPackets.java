...
public class InventoryPackets {
    ...
    public static void register(Protocol1_9To1_8 protocol) {
                    ...
                    if (inventoryTracker.getInventory() != null) {
                        if (inventoryTracker.getInventory().equalsIgnoreCase("minecraft:enchanting_table")) {
                            if (property > 3 && property < 7) {
                                ...
                                wrapper.create(wrapper.getId(), wrapper13 -> {
                                    wrapper13.write(Type.UNSIGNED_BYTE, windowId);
                                    wrapper13.write(Type.SHORT, property);
                                    wrapper13.write(Type.SHORT, enchantID);
            ...
            public void registerMap() {
                ...
                handler(wrapper -> {
                    ...
                    if (throwItem) {
                        ...
                        wrapper.create(ClientboundPackets1_9.SET_SLOT, wrapper12 -> {
                            wrapper12.write(Type.UNSIGNED_BYTE, (short) 0);
                            wrapper12.write(Type.SHORT, slot);
                            wrapper12.write(Type.ITEM, null);
        ...
        protocol.registerServerbound(ServerboundPackets1_9.CLICK_WINDOW, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                handler(wrapper -> {
                    ...
                    if (throwItem) {
                        // Send a packet wiping the slot
                        wrapper.create(ClientboundPackets1_9.SET_SLOT, wrapper1 -> {
                            wrapper1.write(Type.UNSIGNED_BYTE, (short) windowID);
                            wrapper1.write(Type.SHORT, slot);
                            wrapper1.write(Type.ITEM, null);
                        }).scheduleSend(Protocol1_9To1_8.class);
                        // Finally reset to simulate throwing item
        ...
        protocol.registerServerbound(ServerboundPackets1_9.WINDOW_CONFIRMATION, new PacketRemapper() {
            @Override
            public void registerMap() {
                map(Type.UNSIGNED_BYTE); // Window
