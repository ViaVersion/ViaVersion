...
public enum ClientboundPackets26_3 implements ClientboundPacket26_3 {
    ...
    RESPAWN, // 0x53
    ROTATE_HEAD, // 0x54
    SECTION_BLOCKS_UPDATE, // 0x55
    SELECT_ADVANCEMENTS_TAB, // 0x56
    SERVER_DATA, // 0x57
    SET_ACTION_BAR_TEXT, // 0x58
    SET_BORDER_CENTER, // 0x59
    SET_BORDER_LERP_SIZE, // 0x5A
    SET_BORDER_SIZE, // 0x5B
    SET_BORDER_WARNING_DELAY, // 0x5C
    SET_BORDER_WARNING_DISTANCE, // 0x5D
    SET_CAMERA, // 0x5E
    SET_CHUNK_CACHE_CENTER, // 0x5F
    SET_CHUNK_CACHE_RADIUS, // 0x60
    SET_CURSOR_ITEM, // 0x61
    SET_DEFAULT_SPAWN_POSITION, // 0x62
    SET_DISPLAY_OBJECTIVE, // 0x63
    SET_ENTITY_DATA, // 0x64
    SET_ENTITY_LINK, // 0x65
    SET_ENTITY_MOTION, // 0x66
    SET_EQUIPMENT, // 0x67
    SET_EXPERIENCE, // 0x68
    SET_HEALTH, // 0x69
    SET_HELD_SLOT, // 0x6A
    SET_OBJECTIVE, // 0x6B
    SET_PASSENGERS, // 0x6C
    SET_PLAYER_INVENTORY, // 0x6D
    SET_PLAYER_TEAM, // 0x6E
    SET_SCORE, // 0x6F
    SET_SIMULATION_DISTANCE, // 0x70
    SET_SUBTITLE_TEXT, // 0x71
    SET_TIME, // 0x72
    SET_TITLE_TEXT, // 0x73
    SET_TITLES_ANIMATION, // 0x74
    SOUND_ENTITY, // 0x75
    SOUND, // 0x76
    START_CONFIGURATION, // 0x77
    STOP_SOUND, // 0x78
    STORE_COOKIE, // 0x79
    SWING_ANIMATION, // 0x7A
    SYSTEM_CHAT, // 0x7B
    TAB_LIST, // 0x7C
    TAG_QUERY, // 0x7D
    TAKE_ITEM_ENTITY, // 0x7E
    TELEPORT_ENTITY, // 0x7F
    TEST_INSTANCE_BLOCK_STATUS, // 0x80
    TICKING_STATE, // 0x81
    TICKING_STEP, // 0x82
    TRANSFER, // 0x83
    UPDATE_ADVANCEMENTS, // 0x84
    UPDATE_ATTRIBUTES, // 0x85
    UPDATE_MOB_EFFECT, // 0x86
    UPDATE_RECIPES, // 0x87
    UPDATE_TAGS, // 0x88
    PROJECTILE_POWER, // 0x89
    CUSTOM_REPORT_DETAILS, // 0x8A
    SERVER_LINKS, // 0x8B
    TRACKED_WAYPOINT, // 0x8C
    CLEAR_DIALOG, // 0x8D
    SHOW_DIALOG; // 0x8E
